...
function(ftxui_set_options library)
  ...
  if(FTXUI_CLANG_TIDY)
    ...
    set_target_properties(
      ${library} PROPERTIES CXX_CLANG_TIDY
  ...
  target_include_directories(
    ${library} PRIVATE $<BUILD_INTERFACE:${CMAKE_CURRENT_SOURCE_DIR}/src>
  ...
  # static library is later linked into a shared library. Doing it helps some
  # users.
